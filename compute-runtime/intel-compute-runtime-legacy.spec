...
Release: %autorelease
Summary: Compute API support for Intel graphics (legacy)
...
providing compute API support (Level Zero, OpenCL) for Intel graphics hardware architectures (HD Graphics, Xe). (legacy)
